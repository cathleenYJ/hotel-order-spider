...
func GetExpedia(platform map[string]interface{}, dateFrom, dateTo, expediaAccommodationId, hotelName, mrhostId string) {

	fmt.Println()
	fmt.Println(hotelName, mrhostId, expediaAccommodationId)
