...
func GetNewSIM(platform map[string]interface{}, dateFrom, dateTo string) {
	var result string
	...
	for _, hotelRaw := range hotels {
		...
		requestJSON := `{"operationName":"getReservationsSearch","variables":{"spid":"` + hotelId + `","filters":{"checkOutDateRange":{"startDate":"` + dateFrom + `","endDate":"` + dateTo + `"}},"pagination":{"page":1,"pageSize":2000,"sortBy":"checkOutDate","sortOrder":"asc"}},"query":"query getReservationsSearch($spid: ID!, $filters: PlatformReservationsFilterInput, $pagination: PlatformReservationsPaginationInput) {\n  hotel(spid: $spid) {\n    spid\n    platformReservations(filters: $filters, pagination: $pagination) {\n      results {\n        uuid\n        sourceId\n        smPlatformReservationId\n        channel {\n          code\n          name\n          __typename\n        }\n        fromDate\n        toDate\n        checkOutDate\n        channelCreatedAt\n        currency\n        totalAmount {\n          amountAfterTax\n          amountBeforeTax\n          __typename\n        }\n        roomStays {\n          cmRoomRateUuid\n          cmChannelRoomRateUuid\n          roomName\n          numberOfAdults\n          numberOfChildren\n          numberOfInfants\n          guests {\n            companyName\n            firstName\n            middleName\n            lastName\n            __typename\n          }\n          __typename\n        }\n        guests {\n          companyName\n          firstName\n          middleName\n          lastName\n          __typename\n        }\n        profiles {\n          companyName\n          firstName\n          middleName\n          lastName\n          __typename\n        }\n        type\n        pmsDeliveryStatus\n        pmsLastSentAt\n        __typename\n      }\n      sortBy\n      sortOrder\n      page\n      pageSize\n      total\n      __typename\n    }\n    __typename\n  }\n}\n"}`
